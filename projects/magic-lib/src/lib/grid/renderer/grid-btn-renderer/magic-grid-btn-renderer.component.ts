...
import { IMagicGridConfigButtonHeader, IMagicGridConfigHeader } from '../../../other/model/interface/magicGrid.interface';
...
export class MagicGridBtnRendererComponent implements OnInit {
  constructor() { }
