...
import {
  ...
  RowClickedEvent, RowSelectedEvent, StatusPanelDef,
  ValueGetterParams, RowNode,
  IRowNode,
  GridReadyEvent
} from 'ag-grid-community';
import { HttpClient, HttpHeaders } from '@angular/common/http';
import { IMagicEmitRowSelect, IMagicGridConfig, IMagicGridConfigStatusBar, IMagicGridButtons, IMagicValueMasterDetail, IMagicGridRowConfig, IValueGetterParams, IMagicGridConfigStatusBarIsFilter } from '../other/model/interface/magicGrid.interface';
...
export class MagicGridComponent implements OnInit, AfterViewInit {
  ...
  private _gridButtons: IMagicGridButtons = { buttons: [] };
  @Input() set gridButtons(data: IMagicGridButtons) {
  ...
  get gridButtons(): IMagicGridButtons {
...
var widthCellBtnAgGrid = function (sharedBtnTable: IMagicGridButtons): number {
